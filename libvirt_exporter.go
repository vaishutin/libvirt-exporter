...
import (
	...
	"github.com/vaishutin/libvirt-exporter/libvirtSchema"
...
var (
	...
	libvirtDomainInfoMetaDesc = prometheus.NewDesc(
		...
		"Domain metadata",
		[]string{"instance_name", "uuid", "organization_name", "project_name"},
		nil)
	libvirtDomainInfoMaxMemBytesDesc = prometheus.NewDesc(
		...
		[]string{"instance_name", "organization_name", "project_name"},
		nil)
	...
	libvirtDomainVcpuTimeDesc = prometheus.NewDesc(
		...
		[]string{"instance_name", "vcpu", "organization_name", "project_name"},
		nil)
	...
	libvirtDomainMetaBlockDesc = prometheus.NewDesc(
		...
		[]string{"instance_name", "target_device", "source_file", "serial", "bus", "disk_type", "driver_type", "cache", "discard", "organization_name", "project_name"},
		nil)
	libvirtDomainBlockRdBytesDesc = prometheus.NewDesc(
		...
		[]string{"instance_name", "target_device", "organization_name", "project_name"},
		nil)
	...
	libvirtDomainMetaInterfacesDesc = prometheus.NewDesc(
		...
		[]string{"instance_name", "source_bridge", "target_device", "virtual_interface", "organization_name", "project_name"},
		nil)
...
func CollectDomain(ch chan<- prometheus.Metric, stat libvirt.DomainStats) error {
	...
	orgName := desc.Metadata.OvirtVM.Custom.OrganizationName
	projectName := desc.Metadata.OvirtVM.Custom.ProjectName
